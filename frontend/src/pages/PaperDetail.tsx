...
import { apiFetch, extractReferences, saveReferences, listReferences, ingestFromUrl, previewUrl, suggestTags, applyTags, createStandaloneTag, suggestTopics, fetchFigures, extractFiguresForPaper, chatWithFigure, deletePaper, removeAuthor, fetchGraph, fetchPaperInvolves, regenerateSummary, updatePaper, refetchPdf, reextractAbstract, parsePdf, fetchPaperProjects, listProjects, addPaperToProject, removePaperFromProject, getRelatedPapers, discoverAdd } from "../api/client";
...
import type { Paper, Person, Topic, Tag, Reference, Figure, GraphData, ParsedMeta, T_IngestOut, RelatedPaper } from "../types";
...
export default function PaperDetail() {
  ...
  const [leftTab, setLeftTab]   = useState<"abstract" | "pdf" | "figures" | "chapters" | "summary" | "references" | "graph" | "related" | "people" | "meta">("abstract");
  // Figures
